...
export class WorkOrderService {
  ...
  // @upgrade: Replace localStorage with backend API integration for production use
    ...
    return [
      {
        ...
        data: {
          ...
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth() + 1, 20)), 
        },
      },
      {
        docId: "wo_2",
        ...
        data: {
          ...
          workCenterId: "wc_3",
          status: "in-progress", 
          startDate: formatDate(new Date(today.getFullYear(), today.getMonth() - 2, 20)),
      ...
      },
      {
        ...
        data: {
          ...
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth(), 1)),
        },
      },
      {
        docId: "wo_4",
        ...
        data: {
          ...
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth() + 2, 10)),
        },
      },
      {
        docId: "wo_5",
        ...
        data: {
          ...
          status: "open", 
          startDate: formatDate(new Date(today.getFullYear(), today.getMonth() - 2, 20)),
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth() + 1, 1)),
        },
      },
      {
        docId: "wo_6",
        ...
        data: {
          ...
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth() + 3, 20)),
        },
      },
      {
        docId: "wo_7",
        ...
        data: {
          ...
          workCenterId: "wc_5",
          status: "complete", 
          startDate: formatDate(new Date(today.getFullYear(), today.getMonth() - 3, 15)),
          endDate: formatDate(new Date(today.getFullYear(), today.getMonth(), 1)),
        },
      }, 
    ];
